...
class OnboardingHeightScreen extends StatefulWidget {
  ...
  @override
  State<OnboardingHeightScreen> createState() => _State();
}

class _State extends State<OnboardingHeightScreen> {
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            //             context,
            //             MaterialPageRoute(
            //               builder: (context) => Onbo(),
            //             ),
            //           );
            //         }
            //       : null,
            //   style: ElevatedButton.styleFrom(
            //     backgroundColor: (_isCm
            //             ? _cmController.text.isNotEmpty
            //             : (_feetController.text.isNotEmpty &&
            //                 _inchesController.text.isNotEmpty))
            //         ? Colors.green
